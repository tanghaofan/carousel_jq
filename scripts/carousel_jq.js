...
Carousel.prototype.init = function(){
    ...
    this.csArr.eq(this.curMain).find('img').css(this.posObj.mainImgObj);
    ...
    this.csArr.eq(this.curRight)
                                ...
                                .css(this.posObj.midPosObj);
    this.csArr.eq(this.curRight).find('img').css(this.posObj.sideImgObj);
    ...
    this.csArr.eq(this.curRightOuter)
                                     ...
                                     .css(this.posObj.bottomPosObj);
    this.csArr.eq(this.curRightOuter).find('img').css(this.posObj.outerImgObj);
    this.setTimer();
};
